  ...
  <nav class="">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            ...
            <a href="#" class="text-gray-600 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium " >stay_fit</a>
              ...
              <a href="#" class="text-gray-600 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium " >customized meals plans</a>

              <a href="#" class="text-gray-600 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">meals and dessert</a>
        ...
        <x-dropdown>
                <x-slot name="trigger">
<button class="text-xs font-bold uppercase">Welcome {{ user->name }} </button>
                </x-slot>
        </x-dropdown>
        @endcan
            <div class="ml-3 relative">
              <div>
                <button type="button" class="max-w-xs bg-blue-600  rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  <span class="sr-only"></span>
                  <div class="rounded text-white m-2">Register  </div>
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="pt-4 pb-3 border-t border-gray-700">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">hello</div>
